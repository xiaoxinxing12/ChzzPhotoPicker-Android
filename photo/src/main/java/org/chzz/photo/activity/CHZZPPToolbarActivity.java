 ...
 * 描述:
 */
public abstract class CHZZPPToolbarActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void setContentView(@LayoutRes int layoutResID) {
        super.setContentView(R.layout.chzz_pp_toolbar_viewstub);
