 ...
 * 描述:
 */
public class CHZZLoadPhotoTask extends CHZZAsyncTask<Void, ArrayList<CHZZImageFolderModel>> {
    private Context mContext;
    private boolean mTakePhotoEnabled;


    public CHZZLoadPhotoTask(Callback<ArrayList<CHZZImageFolderModel>> callback, Context context, boolean takePhotoEnabled) {
        super(callback);
    ...
    @Override
    protected ArrayList<CHZZImageFolderModel> doInBackground(Void... voids) {
        ArrayList<CHZZImageFolderModel> imageFolderModels = new ArrayList();
        CHZZImageFolderModel allImageFolderModel = new CHZZImageFolderModel(mTakePhotoEnabled);
        HashMap<String, CHZZImageFolderModel> imageFolderModelMap = new HashMap<>();
        ...
        try {
            ...
            CHZZImageFolderModel otherImageFolderModel;
            if (cursor != null && cursor.getCount() > 0) {
                ...
                while (cursor.moveToNext()) {
                    ...
                    if (!TextUtils.isEmpty(imagePath) && isImageFile(imagePath)) {
                        if (firstInto) {
                            allImageFolderModel.name = mContext.getString(R.string.chzz_pp_all_image);
                        ...
                        if (!TextUtils.isEmpty(folderPath)) {
                            if (imageFolderModelMap.containsKey(folderPath)) {
                                ...
                                otherImageFolderModel = new CHZZImageFolderModel(folderName, imagePath);
                ...
                // 添加其他图片目录
                Iterator<Map.Entry<String, CHZZImageFolderModel>> iterator = imageFolderModelMap.entrySet().iterator();
    ...
    public CHZZLoadPhotoTask perform() {
