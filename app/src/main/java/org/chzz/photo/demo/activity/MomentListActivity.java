...
import org.chzz.photo.activity.CHZZPhotoPreviewActivity;
import org.chzz.photo.demo.R;
import org.chzz.photo.demo.model.Moment;
import org.chzz.photo.widget.CHZZNinePhotoLayout;
 ...
 */
public class MomentListActivity extends CHZZPPToolbarActivity implements EasyPermissions.PermissionCallbacks, CHZZNinePhotoLayout.Delegate, CHZZOnRVItemClickListener, CHZZOnRVItemLongClickListener {
    ...
    private CHZZNinePhotoLayout mCurrentClickNpl;
    ...
    private void photoPreviewWrapper() {
        ...
        if (EasyPermissions.hasPermissions(this, perms)) {
            if (mCurrentClickNpl.getItemCount() == 1) {
                ...
                startActivity(CHZZPhotoPreviewActivity.newIntent(this, mDownLoadableCb.isChecked() ? downloadDir : null, mCurrentClickNpl.getCurrentClickItem()));
            } else if (mCurrentClickNpl.getItemCount() > 1) {
                // 预览多张图片

                startActivity(CHZZPhotoPreviewActivity.newIntent(this, mDownLoadableCb.isChecked() ? downloadDir : null, mCurrentClickNpl.getDatas(), mCurrentClickNpl.getCurrentClickItemPosition()));
            }
        } else {
    ...
    @Override
    public void onClickNinePhotoItem(CHZZNinePhotoLayout ninePhotoLayout, View view, int position, String model, List<String> models) {
    ...
    private class MomentAdapter extends CHZZRecyclerViewAdapter<Moment> {

        public MomentAdapter(RecyclerView recyclerView) {
            super(recyclerView, R.layout.item_moment,null,null,null,null);
        }

        @Override
        protected void fillData(CHZZViewHolderHelper helper, int position, Moment moment) {
            ...
            CHZZNinePhotoLayout ninePhotoLayout = helper.getView(R.id.npl_item_moment_photos);
            ninePhotoLayout.init(MomentListActivity.this);
            ninePhotoLayout.setDelegate(MomentListActivity.this);
            ninePhotoLayout.setDatas(moment.photos);
        }
    }
}